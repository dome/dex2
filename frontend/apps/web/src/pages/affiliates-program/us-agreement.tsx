  ...
  return (
    <AffiliatesProgramLayout>
      <Container>
        ...
        <Text as="p">
          7.3 Any statements you make about IceCreamSwap must reflect your honest opinions, beliefs, or experiences and
        ...
        <Text as="p">
          13.1 IceCreamSwap reserves the right to terminate this Agreement in its entirety with or without cause,
        ...
        <Text as="p">
          13.2 IceCreamSwap, in its sole discretion, reserves the right to suspend or terminate your account and refuse
        ...
        <Text as="p">13.3 IceCreamSwap reserves the right to refuse service to anyone for any reason at any time.</Text>
        ...
        <Text as="p">
          (f) Conduct marketing or make any representations of any IceCreamSwap products and services to users in the
