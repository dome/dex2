  ...
  return (
    <>
      <Head>
        ...
        <meta name="twitter:title" content="🦛 USDOGSwap - Get hella thicc tokens on matsnet." />
        <meta
      ...
      <Providers store={store}>
       ...
       {/* <SupportedChainsProvider supportedChains={[ChainId.BOB,ChainId.CORE]}> */}
        <SupportedChainsProvider supportedChains={[ChainId.BOB]}>
          <Blocklist>
